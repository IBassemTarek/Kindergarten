...
import '../../settings.dart';
  class TextFieldLables {
      final String lable;
      final String hint;
      TextFieldLables({required this.hint,required this.lable}); 
  }
class SignIn extends StatelessWidget {
  static List<String> loginTextFieldLables = [
     "Email","Password",
  ];
...
class DataEntry extends StatelessWidget {
  ...
  final List<String> loginTextFieldLables;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
          ...
          return InputField(
          title:  loginTextFieldLables[i].title?? '',
        ); 
          }, 
