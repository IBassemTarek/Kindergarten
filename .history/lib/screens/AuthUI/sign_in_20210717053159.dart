...
class SignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   StreamController<UserModel>? _recipeStreamController = StreamController<UserModel>();
   _recipeStreamController.sink.add(UserModel(id: "id"));
    return Scaffold(
        key: _scaffoldKey,
