          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 15,),
                Text(e['title'],style:Theme.of(context).textTheme.subtitle2?.copyWith(color: kColor9)),
              ],
            ),
          )
        ...
        Row(
          ...
          children: [
            ...
            InkWell(
              ...
              child: Text('Logout',style:Theme.of(context).textTheme.subtitle2?.copyWith(color: kColor12),))
          ],
        )
          ],
        ),
