...
class EducationUnits extends StatelessWidget {  
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      LocaleText("Educational Units",style:Locales?.currentLocale(context).toString() == "ar" ? Theme.of(context).textTheme.headline2 : Theme.of(context).textTheme.headline3,),
      InkWell(
        onTap: (){
             Navigator.push(
                 context,
