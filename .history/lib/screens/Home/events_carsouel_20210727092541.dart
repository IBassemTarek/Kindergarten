...
class EventsCarsouel extends StatelessWidget {  
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      ...
      Padding(
        ...
        child: LocaleText('Events',style:Locales?.currentLocale(context).toString() == "ar" ? Theme.of(context).textTheme.headline2?.copyWith(color: kColor6) : Theme.of(context).textTheme.headline3,),
      ),
      events.isEmpty?Center(child: CircularProgressIndicator()):
  ...
  itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) {
    ...
    imageUrl:  driveURLTransfer(events[itemIndex].url),
