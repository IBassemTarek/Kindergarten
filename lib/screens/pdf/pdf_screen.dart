...
class PdfScreen extends StatefulWidget {
  ...
  final bool whatsApp;
  PdfScreen(
      {required this.whatsApp,required this.title, required this.pdfDriveUrl, required this.source});
  @override
            ...
            child: Padding(
              ...
              child: Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .subtitle1
                    ?.copyWith(fontSize: 14, color: kColor9),
              ),
            )),
        body: localFile != null
            ? SafeArea(
                child: Stack(
                  children: [
                    ...
                    Align(
                        ...
                        Row(
                          ...
                          children: [
                              ...
                              widget.whatsApp?InkWell(
                                
                                  splashColor: Colors.transparent,
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    var whatsappUrl ="whatsapp://send?phone=+966592207651";
                           ...
                           ? InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    await canLaunch(widget.source)
                                        ? await launch(widget.source)
                                        : throw 'Could not launch ${widget.source}';
                                  },
                                  child: Container(
                                    margin: EdgeInsets.all(15),
                                    padding: EdgeInsets.all(6),
                    ...
                    Align(
                        ...
                        child: Image.asset(
                            "assets/images/resources/Vector1.png",
                            height: 0.142053 * _height)),
...
String driveURLTransfer(String str) {
  if (str.substring(0, 24) == "https://drive.google.com") {
    try{
canLaunch("https://drive.google.com/uc?export=view&id=" +
        str.substring(32, 65));
    } 
    catch(e){print(e);}
